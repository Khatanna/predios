...
export const mutationMessages: {
  [K in `${Operation}_${Resource}`]: TitleMessage;
} = {
  CREATE_CITY: {
  ...
  CREATE_CLASIFICATION: {
    ...
    getSuccessMessage: (name) =>
      `La clasificación ${name} se ha creado correctamente`,
    getErrorMessage: (name) =>
      `Ocurrio un error al intentar crear la clasificación ${name}`,
  },
  UPDATE_CLASIFICATION: {
    title: "Clasificación actualizada",
    getSuccessMessage: (name) =>
      `La clasificación ${name} se ha actualizado correctamente`,
    getErrorMessage: (name) =>
      `Ocurrio un error al intentar actualizar la clasificación ${name}`,
  },
  ...
  CREATE_USER: {
    ...
    getErrorMessage: (name) =>
      `Ocurrio un error al intentar crear el usuario ${name}`,
  },
  UPDATE_USER: {
    title: "Usuario actualizado",
    getSuccessMessage: (name) =>
      `El usuario ${name} se ha actualizado correctamente`,
    getErrorMessage: (name) =>
      `Ocurrio un error al intentar actualizar el usuario ${name}`,
  },
  DELETE_USER: {
    ...
    getErrorMessage: (name) =>
      `Ocurrio un error al intentar eliminar el usuario ${name}`,
  },
  CREATE_PERMISSION: {
    title: "Permiso creado",
    getSuccessMessage: (name) =>
      `El permiso ${name} se ha creado correctamente`,
    getErrorMessage: (name) =>
      `Ocurrio un error al intentar crear el permiso ${name}`,
  },
  UPDATE_PERMISSION: {
    title: "Permiso actualizado",
    getSuccessMessage: (name) =>
      `El permiso ${name} se ha actualizado correctamente`,
    getErrorMessage: (name) =>
      `Ocurrio un error al intentar actualizar el permiso ${name}`,
  },
  DELETE_PERMISSION: {
    title: "Permiso eliminado",
    getSuccessMessage: (name) =>
      `El permiso ${name} se ha eliminado correctamente`,
    getErrorMessage: (name) =>
  ...
  CREATE_BENEFICIARY: {
    ...
    getSuccessMessage: (name) =>
      `El beneficiario ${name} se ha creado correctamente`,
    getErrorMessage: (name) =>
      `Ocurrio un error al intentar crear el beneficiario ${name}`,
  },
  UPDATE_BENEFICIARY: {
    title: "Beneficiario actualizado",
    getSuccessMessage: (name) =>
      `El beneficiario ${name} se ha actualizado correctamente`,
    getErrorMessage: (name) =>
      `Ocurrio un error al intentar actualizar el beneficiario ${name}`,
  },
  DELETE_BENEFICIARY: {
    title: "Beneficiario eliminado",
    getSuccessMessage: (name) =>
      `El beneficiario ${name} se ha eliminado correctamente`,
    getErrorMessage: (name) =>
      `Ocurrio un error al intentar eliminar el beneficiario ${name}`,
  },
  CREATE_STATE: {
    title: "Estado de predio creado",
    getSuccessMessage: (name) =>
      `El estado de predio ${name} se ha creado correctamente`,
    getErrorMessage: (name) =>
      `Ocurrio un error al intentar crear el estado de predio ${name}`,
  },
  UPDATE_STATE: {
    title: "Estado de predio actualizado",
    getSuccessMessage: (name) =>
      `El estado de predio ${name} se ha actualizado correctamente`,
    getErrorMessage: (name) =>
      `Ocurrio un error al intentar actualizar el estado de predio ${name}`,
  },
  DELETE_STATE: {
    title: "Estado de predio eliminado",
    getSuccessMessage: (name) =>
      `El estado de predio ${name} se ha eliminado correctamente`,
    getErrorMessage: (name) =>
      `Ocurrio un error al intentar eliminar el estado de predio ${name}`,
  },
  CREATE_STAGE: {
    title: "Etapa creada",
  ...
  UPDATE_STAGE: {
    ...
    getErrorMessage: (name) =>
      `Ocurrio un error al intentar actualizar la etapa ${name}`,
  },
  DELETE_STAGE: {
  ...
  CREATE_UNIT: {
    ...
    getErrorMessage: (name) =>
      `Ocurrio un error al intentar crear la unidad ${name}`,
  },
  UPDATE_UNIT: {
    title: "Unidad actualizada",
    getSuccessMessage: (name) =>
      `La unidad ${name} se ha actualizado correctamente`,
    getErrorMessage: (name) =>
      `Ocurrio un error al intentar actualizar la unidad ${name}`,
  },
  DELETE_UNIT: {
    title: "Unidad eliminada",
    getSuccessMessage: (name) =>
      `La unidad ${name} se ha eliminado correctamente`,
    getErrorMessage: (name) =>
      `Ocurrio un error al intentar eliminar la unidad ${name}`,
  },
  CREATE_TYPE: {
  ...
  CREATE_FOLDERLOCATION: {
    ...
    getSuccessMessage: (name) =>
      `La ubicación de carpeta ${name} se ha creado correctamente`,
    getErrorMessage: (name) =>
  ...
  UPDATE_FOLDERLOCATION: {
    ...
    getSuccessMessage: (name) =>
      `La ubicación de carpeta ${name} se ha actualizado correctamente`,
    getErrorMessage: (name) =>
      `Ocurrio un error al intentar actualizar la ubicación de carpeta ${name}`,
  },
  DELETE_FOLDERLOCATION: {
    title: "Ubicación de carpeta eliminada",
    getSuccessMessage: (name) =>
      `La ubicación de carpeta ${name} se ha eliminado correctamente`,
    getErrorMessage: (name) =>
  ...
  CREATE_PROPERTY: {
    ...
    getErrorMessage: (name) =>
      `Ocurrio un error al intentar crear el predio ${name}`,
  },
  UPDATE_PROPERTY: {
    title: "Predio actualizado",
    getSuccessMessage: (name) =>
      `El predio ${name} se ha actualizado correctamente`,
    getErrorMessage: (name) =>
      `Ocurrio un error al intentar actualizar el predio ${name}`,
  },
  DELETE_PROPERTY: {
    title: "Predio eliminado",
    getSuccessMessage: (name) =>
      `El predio ${name} se ha eliminado correctamente`,
    getErrorMessage: (name) =>
      `Ocurrio un error al intentar eliminar el predio ${name}`,
  },
  CREATE_REFERENCE: {
  ...
  CREATE_TRACKING: {
    ...
    getSuccessMessage: (name) =>
      `El seguimiento ${name} se ha creado correctamente`,
    getErrorMessage: (name) =>
      `Ocurrio un error al intentar crear el seguimiento ${name}`,
  },
  UPDATE_TRACKING: {
    title: "Seguimiento actualizado",
    getSuccessMessage: (name) =>
      `El seguimiento ${name} se ha actualizado correctamente`,
    getErrorMessage: (name) =>
      `Ocurrio un error al intentar actualizar el seguimiento ${name}`,
  },
  DELETE_TRACKING: {
    title: "Seguimiento eliminado",
    getSuccessMessage: (name) =>
      `El seguimiento ${name} se ha eliminado correctamente`,
    getErrorMessage: (name) =>
      `Ocurrio un error al intentar eliminar el seguimiento ${name}`,
  },
  CREATE_OBSERVATION: {
    title: "Observación creada",
    getSuccessMessage: (name) =>
      `La observación ${name} se ha creado correctamente`,
    getErrorMessage: (name) =>
      `Ocurrio un error al intentar crear la observación ${name}`,
  },
  UPDATE_OBSERVATION: {
    title: "Observación actualizada",
    getSuccessMessage: (name) =>
      `La observación ${name} se ha actualizado correctamente`,
    getErrorMessage: (name) =>
      `Ocurrio un error al intentar actualizar la observación ${name}`,
  },
  DELETE_OBSERVATION: {
    title: "Observación eliminada",
    getSuccessMessage: (name) =>
      `La observación ${name} se ha eliminado correctamente`,
    getErrorMessage: (name) =>
      `Ocurrio un error al intentar eliminar la observación ${name}`,
  },
  CREATE_GROUPEDSTATE: {
