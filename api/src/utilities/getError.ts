export const getError = (message: string): Record<string, string> => {
  ...
  return {
    ...
    P2002: message.includes("userType")
      ? "Este tipo de usuario ya existe en el sistema"
      : "Este recurso ya existe en el sistema",
    P2022:
      "Las columnas de esta entidad no están especificadas en la base de datos",
