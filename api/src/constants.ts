...
type Operation = keyof typeof LevelPermission;
...
export const PermissionErrorMessage: {
  ...
  READ_ROLE: "No tiene permiso para ver los roles del sistema",
  CREATE_ROLE: "No tiene permiso para crear nuevos roles en el sistema",
  UPDATE_ROLE: "No tiene permiso para modificar roles del sistema",
  DELETE_ROLE: "No tiene permiso para eliminar roles del sistema",

  READ_UNIT: "No tiene permiso para ver las unidades responsables de sistema",
  CREATE_UNIT:
    "No tiene permiso para crear nuevas unidades responsables del sistema",
  UPDATE_UNIT:
    "No tiene permiso para modificar las unidades responsables del sistema",
  DELETE_UNIT:
    "No tiene permiso para eliminar las unidades responsables del sistema",
  ...
  CREATE_OBSERVATION:
    "No tiene permiso para crear nuevas observaciones del sistema",
  UPDATE_OBSERVATION:
    "No tiene permiso para modificar observaciones del sistema",
  DELETE_OBSERVATION:
    "No tiene permiso para eliminar observaciones del sistema",
  ...
  UPDATE_TYPE:
    "No tiene permiso para modificar los tipos de predio del sistema",
  DELETE_TYPE: "No tiene permiso para eliminar tipos de predio del sistema",

  READ_CLASIFICATION:
    "No tiene permiso para ver a las clasificaciones de predio del sistema",
  CREATE_CLASIFICATION:
    "No tiene permiso para crear nuevas clasificaciones de predio del sistema",
  UPDATE_CLASIFICATION:
    "No tiene permiso para modificar las clasificaciones de predio del sistema",
  DELETE_CLASIFICATION:
    "No tiene permiso para eliminar las clasificaciones de predio del sistema",

  READ_GROUPEDSTATE:
    "No tiene permiso para ver a los estados agrupados del sistema",
  CREATE_GROUPEDSTATE:
    "No tiene permiso para crear nuevos estados agrupados del sistema",
  UPDATE_GROUPEDSTATE:
    "No tiene permiso para modificar los estados agrupados del sistema",
  DELETE_GROUPEDSTATE:
    "No tiene permiso para eliminar los estados agrupados del sistema",

  READ_REFERENCE: "No tiene permiso para ver a las referencias del sistema",
  CREATE_REFERENCE:
    "No tiene permiso para crear nuevas referencias del sistema",
  UPDATE_REFERENCE:
    "No tiene permiso para modificar las referencias del sistema",
  DELETE_REFERENCE:
    "No tiene permiso para eliminar las referencias del sistema",
  ...
  UPDATE_RECORD:
    "No tiene permiso para modificar los registros en el historial del sistema",
  DELETE_RECORD:
    "No tiene permiso para eliminar los registros en el historial del sistema",

  READ_STAGE: "No tiene permiso para ver las etapas de estado del sistema",
  CREATE_STAGE:
    "No tiene permiso para crear nuevas etapas de estado del sistema",
  UPDATE_STAGE:
    "No tiene permiso para modificar las etapas de estado del sistema",
  DELETE_STAGE:
    "No tiene permiso para eliminar las etapas de estado del sistema",

  READ_USERTYPE: "No tiene permiso para ver los tipos de usuario del sistema",
  CREATE_USERTYPE:
    "No tiene permiso para crear nuevos tipos de usuario del sistema",
  UPDATE_USERTYPE:
    "No tiene permiso para modificar los tipos de usuario del sistema",
  DELETE_USERTYPE:
    "No tiene permiso para eliminar los tipos de usuario del sistema",

  READ_BENEFICIARY: "No tiene permiso para ver los beneficiarios del sistema",
  CREATE_BENEFICIARY:
    "No tiene permiso para crear nuevos beneficiarios del sistema",
  UPDATE_BENEFICIARY:
    "No tiene permiso para modificar los beneficiarios del sistema",
  DELETE_BENEFICIARY:
    "No tiene permiso para eliminar los beneficiarios del sistema",

  READ_FOLDERLOCATION:
    "No tiene permiso para ver las ubicaciones de carpeta del sistema",
  CREATE_FOLDERLOCATION:
    "No tiene permiso para crear nuevas ubicaciones de carpeta del sistema",
  UPDATE_FOLDERLOCATION:
    "No tiene permiso para modificar las ubicaciones de carpeta del sistema",
  DELETE_FOLDERLOCATION:
    "No tiene permiso para eliminar las ubicaciones de carpeta del sistema",

  READ_STATE: "No tiene permiso para ver los estados de predio del sistema",
  CREATE_STATE:
    "No tiene permiso para crear nuevos estados de predio del sistema",
  UPDATE_STATE:
    "No tiene permiso para modificar los estados de predio del sistema",
  DELETE_STATE:
    "No tiene permiso para eliminar los estados de predio del sistema",

  READ_MUNICIPALITY: "No tiene permiso para ver los municipios del sistema",
  CREATE_MUNICIPALITY:
    "No tiene permiso para crear nuevos municipios del sistema",
  UPDATE_MUNICIPALITY:
    "No tiene permiso para modificar los municipios del sistema",
  DELETE_MUNICIPALITY:
    "No tiene permiso para eliminar los municipios del sistema",
  ...
  CREATE_TRACKING:
    "No tiene permiso para crear nuevos seguimientos del sistema",
  UPDATE_TRACKING:
    "No tiene permiso para modificar los seguimientos del sistema",
  DELETE_TRACKING:
    "No tiene permiso para eliminar los seguimientos del sistema",
